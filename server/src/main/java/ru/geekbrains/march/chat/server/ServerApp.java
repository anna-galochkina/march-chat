...
//            пришлось пробрасывать значение константы клиенту, чтобы он правильно подсчитывал сообщения (сообщения о запросе статистики не должны считаться),
...
//            (чтобы можно было по разным командам подчитывать сообщения всего /total_stat и от каждого клиента /stat), но на клиенте в этой переменной,
//            всегда по какой то причине 0. 
